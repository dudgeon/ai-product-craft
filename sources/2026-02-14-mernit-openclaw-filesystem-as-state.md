...
- [Filesystem as Agent State](../knowledge-base/horizontal/agents/skills/filesystem-as-agent-state.md) — Agent architecture reduces to filesystem (state) + LLM (orchestrator); company-as-filesystem extends the pattern to enterprise
