...
- [Meta-Skill Pattern](../knowledge-base/horizontal/agents/skills/meta-skill-pattern.md) — Build a "skill that builds skills" to bootstrap agent capabilities consistently; factory pattern for agent skill creation
