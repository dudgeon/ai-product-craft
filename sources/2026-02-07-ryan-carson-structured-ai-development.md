...
- **[Stepwise Task Execution](../knowledge-base/horizontal/agents/skills/stepwise-task-execution.md)**: One-task-at-a-time execution with pause-and-approve checkpoints after each step; catches errors before they compound across dependent tasks
