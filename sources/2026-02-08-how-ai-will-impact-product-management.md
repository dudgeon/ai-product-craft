...
**By**: Lenny Rachitsky
**Source**: [Lenny's Newsletter](https://www.lennysnewsletter.com/p/how-ai-will-impact-product-management)
**Type**: newsletter

## Summary

Rachitsky challenges conventional wisdom about which PM skills AI will disrupt, arguing the opposite of popular belief: AI most profoundly impacts high-level strategic skills (strategy, vision, discovery, goal-setting), while soft skills (stakeholder alignment, communication, team coordination) become more valuable as differentiators. He organizes PM work into three jobs — Shape, Ship, Sync — and rates each sub-task on a 1-5 scale for AI disruption. The key insight: what AI excels at (analyzing large datasets, finding patterns) is exactly what strategic thinking requires. He uses AlphaGo's Move 37 as evidence that AI can discover strategic patterns humans miss.
...
**Lenny Rachitsky · April 9, 2024 · Lenny's Newsletter (Substack)**

### The Counterintuitive Thesis

> I'd love to see a list of core skills for PMs and to what extent they'll be replaced/impacted/influenced by AI.
...
As I often do when thinking about a question, I ran a poll on Twitter and LinkedIn asking which core skills of product management folks think are most likely to be impacted/replaced by AI.
...
3. This post is just the beginning of a discussion.

I think of the PM role as consisting of three jobs, each of which contains a number of tasks and skills:

### 1. Shape the Product 🤖🤖🤖

This part of the job is where you determine/influence what your team builds, and it is where product management is the most different from project manager, or product owner. It's also where you bring the most value to the org.

#### 🤖🤖🤖🤖 Developing a product strategy and vision: Significantly impacted
...
- **Tools to explore:** Dovetail, Sprig, Kraftful, Notably, Viable, Maze
...
*Partial — the full "Ship" section is behind the Lenny's Newsletter paywall. Key ratings from cross-references in lifecycle-framework-v2:*

- **Specs/PRDs**: 🤖🤖🤖 — "Describe what you want in human language, get an 80% complete draft, refine it, and then ship."
- **Release communications**: 🤖🤖🤖🤖 — AI tools generate release notes from commit logs and PRDs.
- **Project management**: Moderate disruption.
- **Scope/priority tradeoffs**: Lower disruption — human judgment remains critical.

### 3. Sync the People 🤖

The PM function least disrupted by AI — stakeholder alignment, team coordination, organizational influence.

*Partial — the full "Sync" section is behind the Lenny's Newsletter paywall. Key quotes from cross-references:*

- "PMs will continue to be the 'glue' or 'conductor' who tie everything together."
- Stakeholder communication rated as the **least** disrupted PM activity.
- Soft skills become the primary competitive differentiator as AI commoditizes analytical and strategic capabilities.
