...
- [Structured Context Loading](../knowledge-base/horizontal/agents/system-design/instruction-design/structured-context-loading.md) — 4-file PRD system as structured context input for agent alignment
...
- [Knowledge Capture as Side Effect](../knowledge-base/horizontal/agents/system-design/instruction-design/knowledge-capture-as-side-effect.md) (enriched) — Rules files as individual-practitioner version of the pattern
