...
- [Structured Context Loading](../../horizontal/agents/system-design/structured-context-loading.md) — The systematic implementation of context-first: purpose-built files loaded before each interaction
