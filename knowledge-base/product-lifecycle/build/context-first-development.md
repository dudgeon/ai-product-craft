...
- [Stepwise Task Execution](../../horizontal/agents/system-design/supervision/stepwise-task-execution.md)
- [Deliberate Context Selection](../../horizontal/context/deliberate-context-selection.md)
- [Structured Context Loading](../../horizontal/agents/system-design/instruction-design/structured-context-loading.md) — The systematic implementation of context-first: purpose-built files loaded before each interaction
