...
- [Filesystem as Agent State](../agents/skills/filesystem-as-agent-state.md) — Filesystem as agent state within one repo; cross-repo context expands the state namespace
