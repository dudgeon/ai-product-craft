...
- [Filesystem as Agent State](../agents/system-design/architecture/filesystem-as-agent-state.md) — Complementary mental model. Agent state is about *what exists*; retrieval architecture is about *how agents find it*. Together they describe the full filesystem-centric agent architecture.
