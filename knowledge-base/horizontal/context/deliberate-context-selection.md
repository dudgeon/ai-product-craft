...
- [Structured Context Loading](../agents/system-design/instruction-design/structured-context-loading.md) — The systematic version: purpose-built files designed to be loaded before each interaction
