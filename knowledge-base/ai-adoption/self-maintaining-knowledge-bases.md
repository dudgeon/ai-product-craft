...
- [Knowledge Capture as Side Effect](../horizontal/agents/system-design/instruction-design/knowledge-capture-as-side-effect.md) — the mechanism that produces self-maintaining knowledge bases
