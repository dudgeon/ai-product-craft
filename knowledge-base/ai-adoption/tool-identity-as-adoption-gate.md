...
- [Agent as Cross-Tool Workflow Hub](../horizontal/agents/system-design/architecture/agent-as-cross-tool-workflow-hub.md) — one of the use-case clusters demonstrating broad non-technical capability
- [Agent-Mediated Self-Reflection](../horizontal/agents/system-design/supervision/agent-mediated-self-reflection.md) — another novel use-case cluster from the same source
